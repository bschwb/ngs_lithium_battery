...
\item What is the solubility limit of lithium $n_s$ in the electrodes?
  ...
  Or depending on electrode,
  because open circuit potential for \ce{Li_xC_6} is 0 at ~0.7 in graph from~\cite{doyle95} Appendix 2-A.

  Solubility limit in the cathode is \SI{22.86}{\mol\dm^{-3}}
