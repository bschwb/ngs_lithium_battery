...
*** NEXT Try capping of open circuit potentials when out of range
...
**** NEXT Draw current open circuit potential manganese
**** TODO Think through how to cap off at top & bottom
